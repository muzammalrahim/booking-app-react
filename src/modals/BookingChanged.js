    ...
    <div className='done-appt'>
      ...
      >
        ...
        <Modal.Body>
          ...
          <div>
            <p className='modal-gray-text'>Your booking is now on Friday,</p>
            <p className='modal-gray-text'>February 10, 2023 at 12:00 pm</p>
          </div>
...
export default function App() {
  ...
  return (
    <>
      ...
      <BookingChanged show={modalShow} onHide={() => setModalShow(false)} />
    </>
  );
}
